...
const CLASSES = {
  container: "grid items-center justify-items-center grid-cols-2 w-screen h-screen",
  boardClass: "grid grid-cols-8 gap-0 w-fit border-3 box-border shadow-2xl",
  whiteTile:
    "flex items-center justify-center size-[10vh] sm:max-lg:size-[8vh] cursor-pointer object-contain bg-[url('/assets/whiteTile.png')]",
  blackTile:
    "flex items-center justify-center size-[10vh] sm:max-lg:size-[8vh] transition duration-150 ease-in object-contain bg-[url('/assets/blackTile.png')]",
  greenTile:
    "flex items-center justify-center size-[10vh] sm:max-lg:size-[8vh] transition duration-150 ease-in cursor-pointer object-contain bg-[url('/assets/greenTile.png')]",
  redTile:
    "flex items-center justify-center size-[10vh] sm:max-lg:size-[8vh] transition duration-150 ease-in cursor-pointer object-contain bg-[url('/assets/redTile.png')]",
  darkRedTile:
    "flex items-center justify-center size-[10vh] sm:max-lg:size-[8vh] transition duration-150 ease-in object-contain bg-[url('/assets/darkRedTile.png')]",
  whitePiece:
    "size-[7vh] sm:max-lg:size-[4vh] rounded-full cursor-pointer object-contain bg-[url('/assets/whitePiece.png')]  bg-cover bg-center bg-no-repeat",
  blackPiece:
    "size-[7vh] sm:max-lg:size-[4vh] rounded-full cursor-pointer object-contain bg-[url('/assets/blackPiece.png')]  bg-cover bg-center bg-no-repeat",
  selected:
